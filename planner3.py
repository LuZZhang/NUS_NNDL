...
if __name__ == "__main__":
    ...
    # dump_action_table(planner.action_table, "results/3_com1_"+str(goal[0])+"_"+str(goal[1])+".json")

    # save your action sequence
    file = open("results/3_maze1_"+str(goal[0])+"_"+str(goal[1])+".txt", "a")
    result = np.array(planner.action_seq)
    np.savetxt("results/3_maze1_"+str(goal[0])+"_"+str(goal[1])+".txt", result, fmt="%.2e")
